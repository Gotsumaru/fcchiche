(function () {
  ...
  function resolveMatchImage(match) {
    ...
    if (source.includes('champ')) {
      return 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=960&q=80';
    }
    if (source.includes('coupe') || source.includes('cp')) {
      return 'https://images.unsplash.com/photo-1517927033932-b3d18e61fb3a?auto=format&fit=crop&w=960&q=80';
    }
    if (source.includes('u1') || source.includes('jeune')) {
      return 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?auto=format&fit=crop&w=960&q=80';
    }
    if (source.includes('fem') || source.includes('dames')) {
      return 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?auto=format&fit=crop&w=960&q=80';
    }
    return 'https://images.unsplash.com/photo-1471295253337-3ceaaedca402?auto=format&fit=crop&w=960&q=80';
  }
