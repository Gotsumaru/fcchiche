(function () {
  ...
  async function loadLatestResults() {
    ...
    try {
      ...
      state.elements.resultsHeader.textContent = 'Les trois derniers résultats toutes équipes confondues';
  ...
  function setEventsMessage(message) {
    ...
    paragraph.className = 'event-card event-card--placeholder';
    paragraph.textContent = message;
    state.elements.events.replaceChildren(paragraph);
  }
  ...
  function setResultsMessage(message) {
    ...
    paragraph.textContent = message;
    state.elements.results.replaceChildren(paragraph);
  }
