(function () {
  ...
  function buildCalendarCard(match) {
    ...
    hero.className = 'calendar-card__hero';

    const media = document.createElement('div');
    media.className = 'calendar-card__media';
    ...
    overlay.className = 'calendar-card__overlay';
    hero.appendChild(overlay);

    const badges = document.createElement('div');
    badges.className = 'calendar-card__hero-badges';

    const tag = document.createElement('span');
    tag.className = 'calendar-card__tag';
    tag.textContent = resolveCompetition(match);
    ...
    content.className = 'calendar-card__content';
