          ...
          <div class="story-grid">
            ...
            <div class="story-grid__gallery">
              <div class="story-canvas">
                <div class="story-canvas__glow" aria-hidden="true"></div>
                <figure class="story-canvas__frame story-canvas__frame--main">
                  <picture>
                    <source
                      srcset="
                      ...
                      "
                      type="image/webp"
                      sizes="(min-width: 72rem) 420px, (min-width: 48rem) 60vw, 100vw"
                    />
                    <source
                    ...
                    <img
                      ...
                      width="1300"
                      height="866"
                      alt="L'équipe fanion du FC Chiché célèbre une victoire devant les supporters"
                      loading="lazy"
                      decoding="async"
                    />
                  </picture>
                </figure>
                <figure class="story-canvas__frame story-canvas__frame--side">
                  <picture>
                    <source
                      srcset="<?= $assetsBase ?>/images/buvette.webp"
                      type="image/webp"
                    />
                    <source
                      srcset="<?= $assetsBase ?>/images/buvette.jpg"
                      type="image/jpeg"
                    />
                    <img
                      ...
                      width="1792"
                      height="1024"
                      alt="Bénévoles et supporters autour de la buvette animée du stade"
                      loading="lazy"
                      decoding="async"
                    />
                  </picture>
                </figure>
                <figure class="story-canvas__frame story-canvas__frame--locker">
                  <picture>
                    <source
                      srcset="
                      ...
                      "
                      type="image/webp"
                      sizes="(min-width: 72rem) 260px, (min-width: 48rem) 40vw, 75vw"
                    />
                    <source
                    ...
                    <img
                      ...
                      width="1200"
                      height="800"
                      alt="Le vestiaire des verts et blancs prêt pour accueillir l'équipe réserve"
                      loading="lazy"
                      decoding="async"
                    />
                  </picture>
                </figure>
                <div class="story-canvas__badge">
                  <span class="story-canvas__badge-title">+ de 450 repas</span>
                  <span class="story-canvas__badge-subtitle">servis sur la saison au club-house</span>
                </div>
                <div class="story-canvas__pulse" aria-hidden="true"></div>
              </div>
            </div>
          </div>
        </div>
