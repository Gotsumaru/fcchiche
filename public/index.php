            ...
            <div class="story-grid__gallery" aria-hidden="true">
              <div class="image-stack">
                <div class="image-stack__item image-stack__item--primary">
                  <div class="image-frame" aria-hidden="true">IMAGE 1200×800</div>
                </div>
                <div class="image-stack__item image-stack__item--secondary">
                  <div class="image-frame" aria-hidden="true">IMAGE 720×900</div>
                </div>
                <div class="image-stack__item image-stack__item--accent">
                  <div class="image-frame" aria-hidden="true">IMAGE 640×640</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="result-showcase">
            <div class="result-showcase__visual" aria-hidden="true">
              <div class="image-frame image-frame--tall" aria-hidden="true">IMAGE 1080×1440</div>
            </div>
        ...
        <div class="container">
          ...
          <div class="sponsor-grid" role="list">
            <figure class="sponsor-card" role="listitem">
              <div class="image-frame image-frame--logo" aria-hidden="true">LOGO 320×180</div>
